...
'DynamicMemory': {
  'type': 'multiple_choice', 
  'question': 'May I copy such an array?',
  'answers': [
...
'FloatingPoint': {
  ...
  'answers': [
    { 'answer': 'Never iterate with a real variable (index)', 'correct': False, 'feedback': '"never" is a little string, one can iterate with anything iterable, and sometimes need to.' },
    { 'answer': 'Never compare floats with ==', 'correct': True, 'feedback': 'As a general rule, floating operation are never perfectly exact ; any floating comparison should allow an epsilon error.' },
    ...
    { 'answer': 'Index value is never 169.0', 'correct': False, 'feedback': 'Nice try ;) actually no, because the step of "1.0" is 2 power 0, it can be exactly encoded in binary basis, and the last value of "index" will exactly be "169.0" ; if the step was "0.1", for example, the value of ìndex" would never be exactly "169.0".' },
  ],
  'code':
'''bool check()
 {
