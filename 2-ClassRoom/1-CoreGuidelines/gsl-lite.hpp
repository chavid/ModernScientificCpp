...
# endif
    ...
    {
        return span< const byte >( reinterpret_cast<byte const *>( data() ), size_bytes() ); // NOLINT
    }
...
{
    return span< const byte >( reinterpret_cast<byte const *>( spn.data() ), spn.size_bytes() ); // NOLINT
}
...
typedef wchar_t const * cwzstring;
#endif
